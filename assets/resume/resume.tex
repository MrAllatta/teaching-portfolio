...
% personal data
\name{Eric}{Allatta}
\title{Math and CS Teacher}                               % optional, remove / comment the line if not wanted
\born{August 31, 1981}                                 % optional, remove / comment the line if not wanted
\address{49 N Decter Dr}{Kerhonkson, NY 12446}{}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
\phone[mobile]{(929) 244-0482}                   % optional, remove / comment the line if not wanted; the optional "type" of the phone can be "mobile" (default), "fixed" or "fax"
%\phone[fixed]{+2~(345)~678~901}
%\phone[fax]{+3~(456)~789~012}
\email{ericallatta@gmail.com}                               % optional, remove / comment the line if not wanted
\homepage{mrallatta.github.io/teaching-portfolio}                         % optional, remove / comment the line if not wanted

% Social icons
\social[linkedin]{eric-allatta}                        % optional, remove / comment the line if not wanted
%\social[xing]{john\_doe}                           % optional, remove / comment the line if not wanted

\social[github]{MrAllatta}                              % optional, remove / comment the line if not wanted
...
\quote{``When we try to pick out anything by itself, we find it hitched to everything else in the universe.'' -- John Muir}                                 % optional, remove / comment the line if not wanted
...
\cventry{2012--2021}{Mathematics \& Computer Science Teacher}{NYCDOE, Academy for Software Engineering}{New York, NY}{}{
  \begin{itemize}
    \item Taught CC Algebra, AP CS Principles, Introduction to CS, Data Science
  \item Designed and implemented integrated mathematics, computer science, and data science curricula, leading to increased student engagement and improved computational thinking skills.
...
\cventry{2013--2021}{Pilot Teacher \& Training Consultant}{CollegeBoard}{New York, NY}{}{
  \begin{itemize}
...
%% \signature{0.3}{signature.png}                     % optional, remove / comment the line if not wanted: first argument goes to \includegraphics > scale
